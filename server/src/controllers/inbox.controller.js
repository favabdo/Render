...
function listChannels(req, res) {
  res.json([
    ...
    },
    {
      ...
      name: 'Chatwoot',
      group: 'الأكثر استخدامًا',
      description: 'استقبل وردّ على أي قناة موصولة بحساب شات ووت بتاعك (واتساب، فيسبوك، إلخ)',
      icon: 'message-square',
      color: '#1F93FF',
      available: true,
      protocolNote: 'بروتوكول Webhook (Push) من شات ووت نفسه — نايل شات بيرد عن طريق Chatwoot API',
    },
