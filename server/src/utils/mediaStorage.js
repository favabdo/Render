...
// في المشروع الأصلي public/ كانت جوا نفس src/.. مباشرة. في الهيكلة الجديدة
// (client/server منفصلين) الفرونت إند بيتقدّم static من client/public، فالملفات
// المرفوعة لازم تتخزن هناك عشان تتقدّم بنفس الـ static middleware في app.js.
const UPLOADS_ROOT = path.join(__dirname, '..', '..', '..', 'client', 'public', 'uploads');
